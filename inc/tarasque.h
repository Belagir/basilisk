 ...
 */
typedef struct tarasque_entity_callbacks {
...
} tarasque_entity_callbacks;

/**
 * @brief Data representing the key components of an entity.
 */
typedef struct tarasque_entity_specific_data {
