 ...
 */
typedef struct BE_render_manager_sdl_impl {
...
static void BE_render_manager_sdl_init(tarasque_entity *self_data)
{
    ...
    BE_render_manager_sdl_impl *init_data = (BE_render_manager_sdl_impl *) self_data;
...
static void BE_render_manager_sdl_deinit(tarasque_entity *self_data)
{
    ...
    BE_render_manager_sdl_impl *data = (BE_render_manager_sdl_impl *) self_data;
...
{
    static BE_render_manager_sdl_impl buffer = { 0u };

    buffer = (BE_render_manager_sdl_impl) {
...
const tarasque_entity_definition BE_DEF_render_manager_sdl = {
        .data_size = sizeof(BE_render_manager_sdl_impl),
