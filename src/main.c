...
int main(void)
{
    ...
    tarasque_entity_scene_add_entity(tarasque_engine_root_entity(handle), "", "Game", (entity_user_data) { 0u });

    tarasque_entity_scene_graft(tarasque_engine_root_entity(handle), "Game", "SDL Graft", (graft_user_data) {
