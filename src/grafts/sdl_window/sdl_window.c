...
void graft_sdl_window(entity_data *entity, void *graft_args)
{
    ...
    tarasque_entity_scene_add_entity(entity, "", "SDL Context",
            graft_entity_sdl_context());

    tarasque_entity_scene_add_entity(entity, "SDL Context", "SDL Window",
    ...
    tarasque_entity_scene_add_entity(entity, "SDL Context/SDL Window", "SDL Event Relay",
